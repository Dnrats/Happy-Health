...
-- -----------------------------------------------------
-- Table `mydb`.`country_has_years`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`country_has_years` (
