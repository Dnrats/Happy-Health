...
apiCall("./models/champion_health.php", 1, 2019);

const tabYear1 = [2015,2016,2017,2018,2019,2020,2021,2022];
let countYear1 = 4;

/* Btn Right */
const btnHappyRight1 = document.querySelector('#right-2');
btnHappyRight1.addEventListener('click', function(){
    if (countYear1 === 7) {
        countYear1 = 0;
        apiCall("./models/champion_health.php", 1, tabYear1[countYear1]);
    }else{
        countYear1 ++;
        apiCall("./models/champion_health.php", 1, tabYear1[countYear1]);
    }
...
/* Btn Left */
const btnHappyLeft1 = document.querySelector('#left-2');
